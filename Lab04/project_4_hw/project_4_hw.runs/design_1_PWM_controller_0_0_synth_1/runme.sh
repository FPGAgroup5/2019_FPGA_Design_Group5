...
HD_PWD='D:/FPGA_Project/Lab4/project_4_hw/project_4_hw.runs/design_1_PWM_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PWM_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PWM_controller_0_0.tcl
