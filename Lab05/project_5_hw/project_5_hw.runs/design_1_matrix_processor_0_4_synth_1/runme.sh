...
HD_PWD='D:/FPGA_HW/project_5_hw/project_5_hw.runs/design_1_matrix_processor_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrix_processor_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrix_processor_0_4.tcl
