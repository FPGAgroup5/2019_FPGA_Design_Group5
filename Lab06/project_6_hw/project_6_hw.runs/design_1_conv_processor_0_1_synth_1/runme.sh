...
HD_PWD='D:/FPGA_HW/project_6_hw/project_6_hw.runs/design_1_conv_processor_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_conv_processor_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_conv_processor_0_1.tcl
